...
.playproof-start-btn:hover { transform: translateY(-2px) scale(1.05); box-shadow: 0 8px 24px rgba(99, 102, 241, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1); }
.playproof-start-btn:hover::before { left: 100%; }
.playproof-start-btn:active { transform: translateY(0); }
.playproof-start-btn svg { width: 20px; height: 20px; fill: white; }
